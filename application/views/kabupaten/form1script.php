<script type="text/javascript">
	var form1Kabupaten = <?php echo json_encode($this->session->userdata('form1_kabupaten')->result_array()) ?>;
	$(document).ready( function () {
		$('#form1_kabupaten').DataTable( {
			dom: 'lfrtBip',
			data: form1Kabupaten,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar Form 1 BumDes Kabupaten <?php echo $this->session->userdata('nama_kabupaten')?>',
