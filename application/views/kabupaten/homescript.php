<script type="text/javascript">
	var bumdesKabupaten = <?php echo json_encode($this->session->userdata('bumdes_kabupaten')->result_array()) ?>;
	$(document).ready( function () {
		$('#bumdes_kabupaten').DataTable( {
			dom: 'lfrtBip',
			data: bumdesKabupaten,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar BumDes Kabupaten <?php echo $this->session->userdata('nama_kabupaten')?>',
