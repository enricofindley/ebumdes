<script type="text/javascript">
	var form2Kelurahan = <?php echo json_encode($this->session->userdata('form2_kelurahan')->result_array()) ?>;
	$(document).ready( function () {
		$('#form2_kelurahan').DataTable( {
			dom: 'lfrtBip',
			data: form2Kelurahan,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar Form 2 Kelurahan/Desa <?php echo $this->session->userdata('nama_kelurahan')?>',
