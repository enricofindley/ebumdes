<script type="text/javascript">
	var form1Kelurahan = <?php echo json_encode($this->session->userdata('form1_kelurahan')->result_array()) ?>;
	$(document).ready( function () {
		$('#form1_kelurahan').DataTable( {
			dom: 'lfrtBip',
			data: form1Kelurahan,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar Form 1 Kelurahan/Desa <?php echo $this->session->userdata('nama_kelurahan')?>',
