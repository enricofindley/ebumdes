<script type="text/javascript">
	var form2Provinsi = <?php echo json_encode($this->session->userdata('form2_provinsi')->result_array()) ?>;
	$(document).ready( function () {
		$('#form2_provinsi').DataTable( {
			dom: 'lfrtBip',
			data: form2Provinsi,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar Form 2 BumDes Provinsi <?php echo $this->session->userdata('nama')?>',
