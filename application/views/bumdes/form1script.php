<script type="text/javascript">
	var form1Bumdes = <?php echo json_encode($this->session->userdata('form1_bumdes')->result_array()) ?>;
	$(document).ready( function () {
		$('#form1_bumdes').DataTable( {
			dom: 'lfrtBip',
			data: form1Bumdes,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar Form 1 BumDes <?php echo $this->session->userdata('nama_bumdes')?>',
