<script type="text/javascript">
	var form2Bumdes = <?php echo json_encode($this->session->userdata('form2_bumdes')->result_array()) ?>;
	$(document).ready( function () {
		$('#form2_bumdes').DataTable( {
			dom: 'lfrtBip',
			data: form2Bumdes,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar Form 2 BumDes <?php echo $this->session->userdata('nama_bumdes')?>',
