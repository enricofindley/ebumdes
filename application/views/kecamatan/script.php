<script type="text/javascript">
	var bumdesKecamatan = <?php echo json_encode($this->session->userdata('bumdes_kecamatan')->result_array()) ?>;
	$(document).ready( function () {
		$('#bumdes_kecamatan').DataTable( {
			dom: 'lfrtBip',
			data: bumdesKecamatan,
			columns: [
			...
			buttons: [
				{
					...
					header: true,
					title: 'Daftar BumDes Kecamatan <?php echo $this->session->userdata('nama_kecamatan')?>',
		...
		buttons: [
			{
				...
				header: true,
				title: 'Daftar Form 2 BumDes Kecamatan <?php echo $this->session->userdata('nama_kecamatan')?>',
				orientation: 'landscape',
				customize: function(doc) {
					doc.defaultStyle.fontSize = 8;
					doc.styles.tableHeader.fontSize = 8;
